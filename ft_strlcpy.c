...
/*   Updated: 2025/05/01 18:11:43 by keitabe          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	printf("src=\"%s\", dstsize=0\nlen = %d\ndest = \"%s\"\n\n", src, len,
// 		dest);
// 	len = ft_strlcpy(dest, src, 1);
// 	printf("src=\"%s\", dstsize=1\nlen = %d\ndest = \"%s\"\n\n", src, len,
// 		dest);
// 	len = ft_strlcpy(dest, src, 5);
// 	printf("src=\"%s\", dstsize=5\nlen = %d\ndest = \"%s\"\n\n", src, len,
// 		dest);
// 	src = "A";
// 	len = ft_strlcpy(dest, src, 0);
// 	printf("src=\"%s\", dstsize=0\nlen = %d\ndest = \"%s\"\n\n", src, len,
...
// 	printf("src=\"%s\", dstsize=10\nlen = %d\ndest = \"%s\"\n\n", src, len,
// 		dest);
// 	src = "A! B?";
// 	len = ft_strlcpy(dest, src, 4);
// 	printf("src=\"%s\", dstsize=4\nlen = %d\ndest = \"%s\"\n\n", src, len,
// 		dest);
// 	src = "lorem ipsum dolor sit amet";
// 	len = ft_strlcpy(dest, src, 9);
// 	printf("src=\"%s\", dstsize=9\nlen = %d\ndest = \"%s\"\n\n", src, len,
// 		dest);
// 	return (0);
// }
